...
#from TorchFly.torchfly.metrics import CategoricalAccuracy, Average, MovingAverage, Speed
from .schedulers import ConstantLRSchedule, WarmupConstantSchedule, WarmupCosineSchedule, \
...
class FlyModel(nn.Module):
    ...
    def configure_optimizers(self, total_num_update_steps) -> [List, List]:
        ...
        if optimizer_name == "AdamW":
            ...
            optimizer = torch.optim.RMSprop(optimizer_grouped_parameters, lr=lr)
        else:
            raise NotImplementedError(
