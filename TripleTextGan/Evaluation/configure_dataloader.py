...
class DataLoaderHandler:
    ...
    def train_dataloader(self,config):
        ...
        train_dataloader = DataLoader(
            train_dataset, batch_size=self.config.training.batch_size, shuffle=True, collate_fn=train_dataset.collate_fn)
    ...
    def valid_dataloader(self,config):
        ...
        val_dataloader = DataLoader(val_dataset, batch_size=self.config.training.batch_size, collate_fn=val_dataset.collate_fn)
    ...
    def test_dataloader(self,config):
        ...
        test_dataloader = DataLoader(test_dataset, batch_size=self.config.training.batch_size, collate_fn=test_dataset.collate_fn)
