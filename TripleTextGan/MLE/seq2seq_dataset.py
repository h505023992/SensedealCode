...
class Seq2SeqDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if item["style"]=='fact':
            item["source_token_ids"] = [1,0,0,0]
        elif item["style"]=='romantic':
            item["source_token_ids"] = [0, 1, 0,0]
        elif item["style"]=='funny':
            item["source_token_ids"] = [0, 0, 1,0]
    ...
    def collate_fn(self, batch):
        ...
        batch_size = len(new_batch["target_token_ids"])
        # (12,2, batch_size, num_head, sql_len+1, head_features)
        # past = torch.randn(size=(12, 2, batch_size, 12, 1, 61))  # 64-3
